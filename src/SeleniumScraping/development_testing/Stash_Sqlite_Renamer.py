...
# Your sqlite path
DB_PATH = "C:/Users/Tim/.stash/stash-go.sqlite"
...
tablenames_command = "SELECT name FROM sqlite_schema WHERE type ='table' AND name NOT LIKE 'sqlite_%';"
cursor.execute(tablenames_command)
table_name = sorted(cursor.fetchall())




cursor.execute("SELECT * FROM performers_scenes")
performers_scenes_name = cursor.fetchall()
...
for i in table_name:
    ...
    globals()[new_name] = cursor.fetchall()
