...
class ShapeFiles:
    ...
    def validate_country(self, country: str) -> str | None:
        ...
        try:
            ...
            return country_obj.name  # type: ignore
...
from SeleniumScraping.driver.utils import start_tor
...
def max_run_time(**kwargs) -> int | float:
    t_max = kwargs["t_max"]
...
@func_set_timeout(max_run_time, allowOverride=True)
def test_timeout(t_max=2):
    for i in range(100):
        sleep(i)
...
dir(test_timeout)
test_timeout.__defaults__

test_timeout.__defaults__
test_timeout.__kwdefaults__
test_timeout.__qualname__
test_timeout.__name__
test_timeout.__class__
test_timeout.__code__
test_timeout.__defaults__
...
dir(test_timeout.__code__)

test_timeout.__code__.co_varnames
